# StateVault DB Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Create database schema migration for StateVault.

**Architecture:** CockroachDB Serverless. dbmate migration tool.

**Tech Stack:** SQL, dbmate.
...
**Files:**
- Create: `db/migrations/20260728000000_init.sql`

**Interfaces:**
- Consumes: None
- Produces: `db/migrations/20260728000000_init.sql`
...
- [ ] **Step 2: Write dbmate init migration file**
...
git commit -m "feat(db): add init migration for StateVault schema"
```
